...
import {
    ReactHeroBoardElement, ReactSevenSegmentComponent
...
export default function SegmentedDisplay({ componentData, handleDeleteComponent, handleMouseDown, showMenu, onPinClicked, isActive }) {
    ...
    return (
        <>
            ...
            ></Moveable>
            <ReactSevenSegmentComponent id={componentData.id}
                                        ref={targetRef}
                                        isActive={isActive}
                                        isDragged={isDragged}
            ...
            {isComponentMenuShowing && isActive && createPortal(
                <CommonComponentOptions handleDeleteComponent={handleDeleteComponent}
                                        ...
                                        showRotate={false}></CommonComponentOptions>
                ,
