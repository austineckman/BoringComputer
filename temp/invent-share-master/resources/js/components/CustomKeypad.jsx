...
import {
    ReactBuzzerComponent, ReactCustomKeypadComponent,
...
export default function CustomKeypad({ componentData, handleDeleteComponent, handleMouseDown, showMenu, onPinClicked, isActive }) {
    ...
    return (
        <>
            ...
            <ReactCustomKeypadComponent
                ...
                rotationTransform={rotationAngle}></ReactCustomKeypadComponent>
